...
def build_graph(ctx: WorkflowContext):
    ...
    g.add_conditional_edges(
        "review",
        lambda s: routing.after_review(s, ctx.settings),
        {"create_pr": "create_pr", "update_pr": "update_pr", "implement": "implement", "debug": "debug", "escalate": "escalate"},
    )
    g.add_conditional_edges(
        "debug",
        routing.after_implement,
